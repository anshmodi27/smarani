    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
          className={cn(
            "h6 w-6 text-muted-foreground rounded-full hover:bg-neutral-300 dark:hover-bg-neutral-700 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition",
